...
public:
    CMainParams() {
        ...
        // guarantees the first 2 characters, when base58 encoded, are "VK"
        base58Prefixes[ZCVIEWING_KEY]      = {0x0B,0x1C};
...
public:
    CTestNetParams() {
        ...
        // guarantees the first 2 characters, when base58 encoded, are "VT"
        base58Prefixes[ZCVIEWING_KEY]      = {0x0B,0x2A};
